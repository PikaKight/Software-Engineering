...
ARCHLDSCRIPT	:= -T"C:/intelFPGA_lite/22.1std/University_Program/Monitor_Program/build/altera-socfpga-unhosted-as.ld"
ASFLAGS		:= $(ARCHASFLAGS)
...
# Files
SYS_FILE_SOF			:= "C:/intelFPGA_lite/22.1std/University_Program/Computer_Systems/DE10-Standard/DE10-Standard_Computer/verilog/DE10_Standard_Computer.sof"
SYS_SCRIPT_JTAG_ID		:= --script="C:/intelFPGA_lite/22.1std/University_Program/Monitor_Program/bin/jtag_instance_check.tcl"
SYS_FILE_ARM_PL			:= --preloader "C:/intelFPGA_lite/22.1std/University_Program/Monitor_Program/arm_tools/u-boot-spl.de10-standard.srec"
SYS_FLAG_ARM_PL_ADDR	:= --preloaderaddr 0xffff14f0

############################################
# Compilation Targets

COMPILE: Lab1Part1.srec
...
CLEAN: 
	$(RM) Lab1Part1.srec Lab1Part1.axf $(OBJS)
